...
CREATE TABLE Produto (
    ...
    Nome_Produto VARCHAR(100) UNIQUE,  -- Adicionando UNIQUE
    Modelo VARCHAR(50),             
    Marca VARCHAR(50),          
    Valor FLOAT
);
...
CREATE TABLE Cliente (
    ...
    Nome_Cliente VARCHAR(100) UNIQUE -- Adicionando UNIQUE  
);
GO
...
CREATE TABLE Funcionario (
    ...
    Nome VARCHAR(100) UNIQUE,  -- Adicionando UNIQUE
    Cargo VARCHAR(50),                       
    Salario FLOAT,
...
CREATE TABLE Loja (
    ...
    Endereco VARCHAR(255) UNIQUE, -- Adicionando UNIQUE          
...
CREATE TABLE Venda (
    ...
    Valor_Total FLOAT UNIQUE, -- Adicionando UNIQUE                   
